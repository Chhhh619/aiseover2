        ...
        <div className="terms-page">
            <div className="terms-container">
                ...
                <section className="terms-section">
                    ...
                    <h3>8. Customer Service Response</h3>
                    <p>8.1 Customer service inquiries will be acknowledged and responded to within two working days. A response constitutes an official reply to the inquiry and does not guarantee immediate resolution or completion of the requested matter.</p>

                    <h3>9. Refund and Cancellation Policy</h3>
                    <p>9.1 No refunds will be issued for completed or partially completed work.</p>
                    <p>9.2 Client initiated cancellations after work has begun are not eligible for refunds.</p>
                    <p>9.3 Your payment will be automatically charged at the start of each new subscription term for the fees applicable to that term, unless you cancel your subscription to our service at least 30 days before the end of the then-current subscription period.</p>

                    <h3>10. Content Management and Removal</h3>
                    <p>If payment is not received by the 30th day from the billing date, the company reserves the right to take the following actions:</p>
                    <p><strong>10.1 Archival of Articles</strong><br />
                        Three days after the payment due date, if payment remains outstanding, the company may archive all the customer's articles that are uploaded by CariSEO. Archived articles will no longer be publicly accessible.</p>
                    <p><strong>10.2 Deletion of Articles</strong><br />
                        If payment is still not received within two days after the articles have been archived, the company reserves the right to permanently delete the archived articles. Deleted articles cannot be recovered.</p>
                    <p>The Company shall not be responsible for any loss of data, content, or business impact arising from archival or deletion due to non-payment. Restoration of archived or deleted articles, if available, may be subject to full payment of outstanding fees and additional administrative charges.</p>

                    <h3>11. Limitation of Liability</h3>
                    <p>11.1 The service provider shall not be liable for any indirect, incidental, or consequential damages arising from the use of the service.</p>

                    <h3>12. Confidentiality</h3>
                    <p>12.1 All client information shared for the purpose of content generation will be treated as confidential.</p>
                    <p>12.2 Confidential information will not be disclosed to third parties except where required by law or for service delivery.</p>

                    <h3>13. Service Modifications</h3>
                    <p>13.1 The service provider reserves the right to modify, suspend, or discontinue the service at any time.</p>
                    <p>13.2 Changes to the terms will be effective upon publication on the service provider's website or official communication channels.</p>

                    <h3>14. Governing Law</h3>
                    <p>14.1 These Terms and Conditions shall be governed by and interpreted in accordance with the laws of Malaysia.</p>
                    <p>14.2 Any disputes shall be subject to the exclusive jurisdiction of Malaysian courts.</p>

                    <h3>15. Reservation of Rights</h3>
                    <p>15.1 The Company reserves the right to amend, modify, suspend, or terminate any part of these Terms and Conditions, its services, features, pricing, or policies at any time, with or without prior notice, at its sole discretion.</p>
                </section>
